...
export const registerUser = (email, password, passwordConfirmation, nickname, first_name, last_name, phone, history) => {
  return dispatch => {
    axios.post('/api/auth', { email, password, password_confirmation: passwordConfirmation, nickname, first_name, last_name, phone })
      .then(res => {
